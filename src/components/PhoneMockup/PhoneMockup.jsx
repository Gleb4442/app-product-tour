...
import { GreetingLoadingScreen } from './Screens/GreetingLoadingScreen';

export default function PhoneMockup({ activeStage, preArrivalStep, scale = 1, isInitialLoading }) {
    return (
        <div
            className="relative w-[280px] h-[580px] bg-[#3f2f42] rounded-[3rem] border-[4px] border-[#3f2f42] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] flex flex-col shrink-0 z-10"
        ...
        >
            ...
            <div className="flex-1 w-full bg-slate-50 rounded-[2.7rem] relative overflow-hidden flex flex-col border-[5px] border-black">
                ...
                {/* --- STRAGES --- */}
                <GreetingLoadingScreen active={isInitialLoading} />
